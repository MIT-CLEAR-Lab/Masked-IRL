...
class MaskedRL_No_Lang:
    def __init__(self, params, featurizer, demos, all_trajs, 
        ...
        self.finetune_demo_language_instructions = theta_to_language(finetune_demo_thetas, self.language_ambiguity)
    ...
    def evaluate(self, human_win_rates, num_samples=100, return_rewards=False):
        ...
        for info in human_win_rates:
            ...
            inst = theta_to_language([theta], self.language_ambiguity)[0]
            with torch.no_grad():
